...
public static class StateMachineFactory
{
    public static StateMachine CreateStateMachine(Enemy owner, Type startType, NonCombatStateType nonCombatStateType)
    {
        ...
        stateMachine.AddGlobalTransition<InvestigateState>(() => owner.IsNoiseDetected && owner.NoiseAmount > NoiseManager.Instance.InvestigateThreshold && stateMachine.CurrentState.GetType() != typeof(SuspectState), () => owner.investigateUseStartDelay = true); // 소음 감지 시 조사 상태로 전환
